...
Use tezos-nft-sample:
https://github.com/baking-bad/tezos-nft-sample

After following all the instructions there, take files from "tezor" folder of current repository and put them here:

.../tezos-nft-sample/client.py

.../tezos-nft-sample/src/nft_balance.ligo

.../tezos-nft-sample/src/nft_balance.tz
